...
import com.engine.classic.board.MoveUtils;
import com.engine.classic.pieces.Piece;
import com.engine.classic.player.Player;
import com.engine.classic.player.ai.StandardBoardEvaluator;
import com.google.common.collect.Lists;
import com.pgn.FenUtilities;
import com.pgn.MySqlGamePersistence;
...
//        this.gameFrame.add(debugPanel, BorderLayout.SOUTH);
    ...
    private void setDefaultLookAndFeelDecorated(boolean b) {
...
//        Table.get().getDebugPanel().redo();
    ...
    private static class AIThinkTank extends SwingWorker<Move, String> {
		...
		protected Move doInBackground() throws Exception {
			...
			final com.engine.classic.player.ai.MoveStrategy miniMax = new com.engine.classic.player.ai.MiniMax(4);
